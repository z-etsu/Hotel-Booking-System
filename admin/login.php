...
<html lang="en">
    <head>
        ...
        <title>Admin Login - Elegante</title>
        ...
        <style>
            ...
            .auth-form input {
                width: 100%;
                padding: 1rem 1.25rem; /* Bigger padding for larger inputs */
                border: 2px solid #e0e0e0; /* Thicker, defined border */
                border-radius: 6px;
            ...
            .auth-form input:focus {
                ...
                box-shadow: 0 0 0 3px rgba(184, 134, 11, 0.2); /* Soft glow */
            ...
            <div class="container">
                <div class="footer-grid">
                    <div class="footer-info">
                        ...
                        <p>
                            Experience luxury and comfort in the heart of Manila. Our hotel offers exceptional service,
                            elegant accommodations, and unforgettable experiences.
                        </p>
