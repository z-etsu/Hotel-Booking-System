...
<head>
  ...
  <style>
    ...
    .modal-actions a.home-btn {
      background-color: var(--accent);
      color: white;
    }

    .modal-actions a.home-btn:hover {
...
<body class="page-transition">
  ...
  <div id="successModal" class="success-modal show">
    <div class="modal-content">
      ...
      <p>Welcome back! You have been successfully logged in. Click the button below to go to the home page.</p>
